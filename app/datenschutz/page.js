...
const COPY = {
  de: {
    ...
    processing: 'Was wir verarbeiten', processingItems: [
      ...
      <><b>Newsletter.</b> Nur wenn du dich anmeldest, speichern wir deine E-Mail-Adresse, um dir den Newsletter zu senden. Abmeldung jederzeit möglich.</>,
  ...
  en: {
    ...
    processing: 'What we process', processingItems: [
      ...
      <><b>Newsletter.</b> If you subscribe, we store your email address to send the newsletter. You can unsubscribe at any time.</>,
  ...
  bg: {
    ...
    processing: 'Какво обработваме', processingItems: [
      ...
      <><b>Бюлетин.</b> Ако се абонираш, пазим имейл адреса ти, за да изпращаме бюлетина. Можеш да се отпишеш по всяко време.</>,
