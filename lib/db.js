...
// A past event page should turn a dead search landing into a useful next step,
// without loading the catalog into memory. Suggestions are current events
// within a bounded geographic radius. Family fit and shared categories rank
// first, then proximity/date. Expiry uses each event's IANA timezone, matching
// expireFinished(), never the host's.
