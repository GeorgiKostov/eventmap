...
export const CATS = {
  ...
  market: { color: '#5B8C4A' },
  music: { color: '#7A5CC7' },
  party: { color: '#A21CAF' }, // fuchsia — distinct from music's purple; white glyph clears ≥3:1
  culture: { color: '#3F7CA8' },
  food: { color: '#A0750A' }, // darkened ~13% from #B8860B so a white glyph clears ≥3:1 (see design-system.md)
  sport: { color: '#2E9C8C' },
  workshop: { color: '#A85CA0' },
  eclipse: { color: '#26356F' },
  // -- places (evergreen locations, kind='place') --
  playground: { color: '#9D9228' }, // darkened ~13% from #B5A82E for white-glyph contrast (design-system.md)
  pool: { color: '#0EA5C4' },
  park: { color: '#4B9B4E' },
  trail: { color: '#7A6350' },
...
// Exported so the map can rasterize the same glyphs into GL pin sprites.
export const P = {
  // users (family)
  ...
  // martini glass (party) — unmistakable nightlife, clean at small sizes
  party: ['M8 22h8', 'M12 11v11', 'M19 3H5l7 8 7-8Z'],
  // landmark (culture)
  ...
  // crescent (eclipse) — one bold silhouette that stays legible at 15px
  eclipse: ['M20 15.5A8 8 0 1 1 8.5 4 6.5 6.5 0 0 0 20 15.5Z'],
...
export const EVENT_CATS = ['family', 'festival', 'market', 'music', 'party', 'culture', 'food', 'sport', 'workshop'];
