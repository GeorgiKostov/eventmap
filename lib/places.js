...
export const PLACES = [
  ...
  { name: 'Bürserberg', aliases: ['Buerserberg'], region: 'Vorarlberg', lat: 47.146648, lng: 9.777683, pop: 574 },
  ...
  { name: 'Wieselburg', aliases: [], region: 'Niederösterreich', lat: 48.1299, lng: 15.1377, pop: 4959 },
  ...
  // Germany metro set 2 (2026-07-17): Hamburg, Köln, Frankfurt + their 40km
  // rings (lib/crawl-scopes.js). Hard rule 8 — coverage unreachable by search is
  // invisible. Coords off our own Nominatim; umlaut aliases because
  // normalizePlace folds diacritics ("Köln"→"koln", so a user typing "koeln"
  // needs the alias).
  { name: 'Hamburg', aliases: [], region: 'Hamburg', lat: 53.5502, lng: 10.0013, pop: 1910000 },
  { name: 'Köln', aliases: ['Cologne', 'Koeln'], region: 'Nordrhein-Westfalen', lat: 50.9384, lng: 6.9600, pop: 1090000 },
  { name: 'Frankfurt am Main', aliases: ['Frankfurt'], region: 'Hessen', lat: 50.1106, lng: 8.6821, pop: 776000 },
  { name: 'Düsseldorf', aliases: ['Duesseldorf'], region: 'Nordrhein-Westfalen', lat: 51.2254, lng: 6.7763, pop: 631000 },
  { name: 'Bonn', aliases: [], region: 'Nordrhein-Westfalen', lat: 50.7353, lng: 7.1025, pop: 331000 },
  { name: 'Wiesbaden', aliases: [], region: 'Hessen', lat: 50.0820, lng: 8.2417, pop: 278000 },
  { name: 'Mainz', aliases: [], region: 'Rheinland-Pfalz', lat: 49.9995, lng: 8.2736, pop: 218000 },
  { name: 'Darmstadt', aliases: [], region: 'Hessen', lat: 49.8728, lng: 8.6512, pop: 160000 },
  { name: 'Offenbach am Main', aliases: ['Offenbach'], region: 'Hessen', lat: 50.1055, lng: 8.7611, pop: 130000 },
  { name: 'Leverkusen', aliases: [], region: 'Nordrhein-Westfalen', lat: 51.0325, lng: 6.9881, pop: 164000 },
  { name: 'Neuss', aliases: [], region: 'Nordrhein-Westfalen', lat: 51.1982, lng: 6.6916, pop: 154000 },
  { name: 'Lüneburg', aliases: ['Lueneburg'], region: 'Niedersachsen', lat: 53.2487, lng: 10.4079, pop: 77000 },
  { name: 'Bergisch Gladbach', aliases: [], region: 'Nordrhein-Westfalen', lat: 50.9929, lng: 7.1277, pop: 112000 },
  { name: 'Hanau', aliases: [], region: 'Hessen', lat: 50.1329, lng: 8.9170, pop: 100000 },
  { name: 'Norderstedt', aliases: [], region: 'Schleswig-Holstein', lat: 53.7090, lng: 9.9892, pop: 80000 },
  { name: 'Rüsselsheim am Main', aliases: ['Rüsselsheim', 'Ruesselsheim'], region: 'Hessen', lat: 49.9949, lng: 8.4117, pop: 66000 },
  { name: 'Bad Homburg', aliases: [], region: 'Hessen', lat: 50.2284, lng: 8.6130, pop: 55000 },
  { name: 'Hürth', aliases: ['Huerth'], region: 'Nordrhein-Westfalen', lat: 50.8807, lng: 6.8766, pop: 61000 },
  { name: 'Stade', aliases: [], region: 'Niedersachsen', lat: 53.6024, lng: 9.3680, pop: 48000 },
  { name: 'Oberursel', aliases: [], region: 'Hessen', lat: 50.2033, lng: 8.5834, pop: 46000 },
  { name: 'Elmshorn', aliases: [], region: 'Schleswig-Holstein', lat: 53.7532, lng: 9.6525, pop: 50000 },
  { name: 'Ahrensburg', aliases: [], region: 'Schleswig-Holstein', lat: 53.6737, lng: 10.2359, pop: 34000 },
  { name: 'Pinneberg', aliases: [], region: 'Schleswig-Holstein', lat: 53.7279, lng: 9.6980, pop: 43000 },
  { name: 'Neu-Isenburg', aliases: [], region: 'Hessen', lat: 50.0464, lng: 8.6718, pop: 38000 },
  { name: 'Langen', aliases: [], region: 'Hessen', lat: 49.9915, lng: 8.6667, pop: 39000 },
  { name: 'Rodgau', aliases: [], region: 'Hessen', lat: 50.0177, lng: 8.8853, pop: 46000 },
  { name: 'Troisdorf', aliases: [], region: 'Nordrhein-Westfalen', lat: 50.8153, lng: 7.1593, pop: 75000 },
  { name: 'Wedel', aliases: [], region: 'Schleswig-Holstein', lat: 53.5810, lng: 9.7039, pop: 34000 },
  // Ring towns whose sources were registered + crawled 2026-07-18 (Hamburg +
  // Köln go-live) but weren't yet in the metro-2 gazetteer block above — hard
  // rule 8: their events (Bergheim 99, Sankt Augustin 86, Dormagen 33, …) are
  // in prod and must be typeable. Centroids from the probed catalogs.
  { name: 'Dormagen', aliases: [], region: 'Nordrhein-Westfalen', lat: 51.0944, lng: 6.8419, pop: 65000 },
  { name: 'Bergheim', aliases: [], region: 'Nordrhein-Westfalen', lat: 50.9556, lng: 6.6394, pop: 62000 },
  { name: 'Sankt Augustin', aliases: ['St. Augustin'], region: 'Nordrhein-Westfalen', lat: 50.7706, lng: 7.1867, pop: 56000 },
  { name: 'Bornheim', aliases: [], region: 'Nordrhein-Westfalen', lat: 50.7614, lng: 7.0044, pop: 49000 },
  { name: 'Buxtehude', aliases: [], region: 'Niedersachsen', lat: 53.4767, lng: 9.6931, pop: 40000 },
  { name: 'Geesthacht', aliases: [], region: 'Schleswig-Holstein', lat: 53.4361, lng: 10.3772, pop: 31000 },
];

const AUSTRIAN_REGIONS = new Set([
  'Wien', 'Steiermark', 'Oberösterreich', 'Salzburg', 'Tirol', 'Kärnten',
  'Niederösterreich', 'Vorarlberg', 'Burgenland',
]);

function placeCountry(place) {
  if (place.region === 'Bulgaria') return 'BG';
  return AUSTRIAN_REGIONS.has(place.region) ? 'AT' : 'DE';
}
...
export function searchPlaces(query, { extra, limit = 6 } = {}) {
  ...
  for (const [name, c] of extra || []) {
    ...
    scored.push({ label: name, lat: c.lat, lng: c.lng, country: null, hint: null, keys: [key], score: score + 5 });
  }
