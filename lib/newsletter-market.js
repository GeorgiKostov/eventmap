...
// The five prepared Austrian city editions are live. Adding a slug here is a
// launch decision and must happen together with its real Thursday send path.
export const NEWSLETTER_EDITION_SLUGS = ['linz', 'wien', 'graz', 'salzburg', 'innsbruck'];
...
// Retained for older callers: recurring editions are currently Austrian.
// Signup availability itself is edition-based, not country-based.
