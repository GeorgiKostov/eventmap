...
import { fetchTwoHopEvents, TWOHOP_SOURCES } from '../lib/twohop-events.js';
...
// parseJsonLdEvents lives in lib/jsonld-events.js (imported at the top) so the
// two-hop adapter (lib/twohop-events.js) reuses the exact same @graph-recursing
// parser on each detail page — one definition, like lib/microdata-events.js.
