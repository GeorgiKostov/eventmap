...
| `cms` | Adapter routing key such as `gem2go`, `dvv`, `sitepark-ical`, `twohop`, `pflaster`, `salzburgarena`, `grazer-spielstaetten`, `bregenzer-festspiele`, `last-space`, `florentine`, `other`, `unknown`, or null. Gates source-specific parsers in the waterfall. |
| `discovered_at` | When first registered. |
| `page_hash` | sha256 of the stripped page text from the last crawl — change-detection. |
| `feed_kind` | Which route won the *last* crawl: generic structured routes (`jsonld`, `ical`, `microdata`, `rss`), CMS/venue adapters (including `gem2go`, `siteswift`, `kalkalpen`, `naturfreunde`, `kinderfreunde`, `twohop`, `pflaster`, `salzburgarena`, `grazer-spielstaetten`, `bregenzer-festspiele`, `posthof`, `rockhouse`, `brucknerhaus`, `kapu`, `tabakfabrik`, `schlachthof-wels`, `last-space`, `florentine`), `llm`, or null. |
