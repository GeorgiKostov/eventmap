...
| `feed_kind` | Which route won the *last* crawl: generic structured routes (`jsonld`, `ical`, `microdata`, `rss`), CMS/venue adapters (including `gem2go`, `siteswift`, `kalkalpen`, `naturfreunde`, `kinderfreunde`, `pflaster`, `salzburgarena`, `grazer-spielstaetten`, `bregenzer-festspiele`, `posthof`, `rockhouse`, `brucknerhaus`, `kapu`, `tabakfabrik`, `schlachthof-wels`), `llm`, or null. |
