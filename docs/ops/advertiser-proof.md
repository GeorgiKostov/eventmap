...
| Do landings lead to discovery? | Counts and unique visitors for `event_map_open`, `event_recommendation_open`, `event_source_open`, and `newsletter_signup_started`, divided by unique landing visitors. | PostHog |
